		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[S5A-02] DATA BINDING 3",
									"targetURL": "#sync5zux0213-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5zux0213-display": {
								"semanticObject": "sync5zux0213",
								"action": "display",
								"description": "[S5A-02] DATA BINDING 3",
								"title": "[S5A-02] DATA BINDING 3",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.zux0213",
									"url": sap.ui.require.toUrl("sync5/zux0213")
								}
							}
						}
					}
