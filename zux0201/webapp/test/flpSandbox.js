		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[S5A-02] BASIC 1",
									"targetURL": "#sync5zux0201-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5zux0201-display": {
								"semanticObject": "sync5zux0201",
								"action": "display",
								"description": "[S5A-02] BASIC 1",
								"title": "[S5A-02] BASIC 1",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.zux0201",
									"url": sap.ui.require.toUrl("sync5/zux0201")
								}
							}
						}
					}
