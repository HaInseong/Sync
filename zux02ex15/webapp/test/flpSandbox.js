		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[S5A-02] TABLE TEST 1",
									"targetURL": "#sync5zux02ex15-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5zux02ex15-display": {
								"semanticObject": "sync5zux02ex15",
								"action": "display",
								"description": "[S5A-02] TABLE TEST 1",
								"title": "[S5A-02] TABLE TEST 1",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.zux02ex15",
									"url": sap.ui.require.toUrl("sync5/zux02ex15")
								}
							}
						}
					}
