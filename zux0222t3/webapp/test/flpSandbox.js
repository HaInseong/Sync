		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[S5A-02] Final Assignment 3",
									"targetURL": "#sync5zux0222t3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5zux0222t3-display": {
								"semanticObject": "sync5zux0222t3",
								"action": "display",
								"description": "[S5A-02] Final Assignment 3",
								"title": "[S5A-02] Final Assignment 3",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.zux0222t3",
									"url": sap.ui.require.toUrl("sync5/zux0222t3")
								}
							}
						}
					}
