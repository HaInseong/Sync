		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[S5A-02] DATA BINDING 1",
									"targetURL": "#sync5zux0211-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5zux0211-display": {
								"semanticObject": "sync5zux0211",
								"action": "display",
								"description": "[S5A-02] DATA BINDING 1",
								"title": "[S5A-02] DATA BINDING 1",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.zux0211",
									"url": sap.ui.require.toUrl("sync5/zux0211")
								}
							}
						}
					}
