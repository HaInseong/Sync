		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[S5A-02] BUTTON BINDING",
									"targetURL": "#sync5zux02ex12-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5zux02ex12-display": {
								"semanticObject": "sync5zux02ex12",
								"action": "display",
								"description": "[S5A-02] BUTTON BINDING",
								"title": "[S5A-02] BUTTON BINDING",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.zux02ex12",
									"url": sap.ui.require.toUrl("sync5/zux02ex12")
								}
							}
						}
					}
