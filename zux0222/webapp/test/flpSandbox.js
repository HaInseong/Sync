		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[S5A-02] sap.ui.table",
									"targetURL": "#sync5zux0222-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5zux0222-display": {
								"semanticObject": "sync5zux0222",
								"action": "display",
								"description": "[S5A-02] sap.ui.table",
								"title": "[S5A-02] sap.ui.table",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.zux0222",
									"url": sap.ui.require.toUrl("sync5/zux0222")
								}
							}
						}
					}
