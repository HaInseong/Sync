		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[S5A-22] FILTER TEST",
									"targetURL": "#sync5zux0221test-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5zux0221test-display": {
								"semanticObject": "sync5zux0221test",
								"action": "display",
								"description": "[S5A-22] FILTER TEST",
								"title": "[S5A-22] FILTER TEST",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.zux0221test",
									"url": sap.ui.require.toUrl("sync5/zux0221test")
								}
							}
						}
					}
