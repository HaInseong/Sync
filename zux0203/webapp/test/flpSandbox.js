		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[S5A-02] BASIC 3",
									"targetURL": "#sync5zux0203-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5zux0203-display": {
								"semanticObject": "sync5zux0203",
								"action": "display",
								"description": "[S5A-02] BASIC 3",
								"title": "[S5A-02] BASIC 3",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.zux0203",
									"url": sap.ui.require.toUrl("sync5/zux0203")
								}
							}
						}
					}
