		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[S5A-02] TEST 2",
									"targetURL": "#sync5zux02ex03-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5zux02ex03-display": {
								"semanticObject": "sync5zux02ex03",
								"action": "display",
								"description": "[S5A-02] TEST 2",
								"title": "[S5A-02] TEST 2",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.zux02ex03",
									"url": sap.ui.require.toUrl("sync5/zux02ex03")
								}
							}
						}
					}
