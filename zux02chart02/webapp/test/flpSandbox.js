		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Chart Sample 2",
									"targetURL": "#sync5zux02chart02-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5zux02chart02-display": {
								"semanticObject": "sync5zux02chart02",
								"action": "display",
								"description": "Chart Sample 2",
								"title": "Chart Sample 2",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.zux02chart02",
									"url": sap.ui.require.toUrl("sync5/zux02chart02")
								}
							}
						}
					}
