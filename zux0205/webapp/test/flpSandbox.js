		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[S5A-02] Basic 5",
									"targetURL": "#sync5zux0205-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5zux0205-display": {
								"semanticObject": "sync5zux0205",
								"action": "display",
								"description": "[S5A-02] Basic 5",
								"title": "[S5A-02] Basic 5",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.zux0205",
									"url": sap.ui.require.toUrl("sync5/zux0205")
								}
							}
						}
					}
