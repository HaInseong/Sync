		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[S5A-22] COMBOBOX FILTER TEST",
									"targetURL": "#sync5zux0221test2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5zux0221test2-display": {
								"semanticObject": "sync5zux0221test2",
								"action": "display",
								"description": "[S5A-22] COMBOBOX FILTER TEST",
								"title": "[S5A-22] COMBOBOX FILTER TEST",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.zux0221test2",
									"url": sap.ui.require.toUrl("sync5/zux0221test2")
								}
							}
						}
					}
