		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[S5A-02] DATA BINDING 4",
									"targetURL": "#sync5zux0214-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5zux0214-display": {
								"semanticObject": "sync5zux0214",
								"action": "display",
								"description": "[S5A-02] DATA BINDING 4",
								"title": "[S5A-02] DATA BINDING 4",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.zux0214",
									"url": sap.ui.require.toUrl("sync5/zux0214")
								}
							}
						}
					}
