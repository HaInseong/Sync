		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[S5A-02] BASIC 2",
									"targetURL": "#sync5zux0202-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5zux0202-display": {
								"semanticObject": "sync5zux0202",
								"action": "display",
								"description": "[S5A-02] BASIC 2",
								"title": "[S5A-02] BASIC 2",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.zux0202",
									"url": sap.ui.require.toUrl("sync5/zux0202")
								}
							}
						}
					}
