		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[S5A-02] BASIC 6",
									"targetURL": "#sync5zux0206-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5zux0206-display": {
								"semanticObject": "sync5zux0206",
								"action": "display",
								"description": "[S5A-02] BASIC 6",
								"title": "[S5A-02] BASIC 6",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.zux0206",
									"url": sap.ui.require.toUrl("sync5/zux0206")
								}
							}
						}
					}
