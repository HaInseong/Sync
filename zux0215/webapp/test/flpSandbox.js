		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[S5A-02] TABLE",
									"targetURL": "#sync5zux0215-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5zux0215-display": {
								"semanticObject": "sync5zux0215",
								"action": "display",
								"description": "[S5A-02] TABLE",
								"title": "[S5A-02] TABLE",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.zux0215",
									"url": sap.ui.require.toUrl("sync5/zux0215")
								}
							}
						}
					}
