		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Chart Sample 01 - Controller",
									"targetURL": "#sync5zux02chart01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5zux02chart01-display": {
								"semanticObject": "sync5zux02chart01",
								"action": "display",
								"description": "Chart Sample 01 - Controller",
								"title": "Chart Sample 01 - Controller",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.zux02chart01",
									"url": sap.ui.require.toUrl("sync5/zux02chart01")
								}
							}
						}
					}
