		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[S5A-02] Basic 4",
									"targetURL": "#sync5zux0204-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5zux0204-display": {
								"semanticObject": "sync5zux0204",
								"action": "display",
								"description": "[S5A-02] Basic 4",
								"title": "[S5A-02] Basic 4",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.zux0204",
									"url": sap.ui.require.toUrl("sync5/zux0204")
								}
							}
						}
					}
