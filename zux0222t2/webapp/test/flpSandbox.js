		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[S5A-02] Final Assignment 2",
									"targetURL": "#sync5zux0222t2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5zux0222t2-display": {
								"semanticObject": "sync5zux0222t2",
								"action": "display",
								"description": "[S5A-02] Final Assignment 2",
								"title": "[S5A-02] Final Assignment 2",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.zux0222t2",
									"url": sap.ui.require.toUrl("sync5/zux0222t2")
								}
							}
						}
					}
