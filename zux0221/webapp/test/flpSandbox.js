		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[S5A-02] Table, Filter",
									"targetURL": "#sync5zux0221-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5zux0221-display": {
								"semanticObject": "sync5zux0221",
								"action": "display",
								"description": "[S5A-02] Table, Filter",
								"title": "[S5A-02] Table, Filter",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.zux0221",
									"url": sap.ui.require.toUrl("sync5/zux0221")
								}
							}
						}
					}
