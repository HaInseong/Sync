		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[S5A-02] Final Assignment 1",
									"targetURL": "#sync5zux0222t1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5zux0222t1-display": {
								"semanticObject": "sync5zux0222t1",
								"action": "display",
								"description": "[S5A-02] Final Assignment 1",
								"title": "[S5A-02] Final Assignment 1",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.zux0222t1",
									"url": sap.ui.require.toUrl("sync5/zux0222t1")
								}
							}
						}
					}
