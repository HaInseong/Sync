		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[S5A-02] DATA BINDING 2",
									"targetURL": "#sync5zux0212-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sync5zux0212-display": {
								"semanticObject": "sync5zux0212",
								"action": "display",
								"description": "[S5A-02] DATA BINDING 2",
								"title": "[S5A-02] DATA BINDING 2",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync5.zux0212",
									"url": sap.ui.require.toUrl("sync5/zux0212")
								}
							}
						}
					}
